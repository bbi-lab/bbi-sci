...
gen_barnyard_plot_generic <- function(cds, sample_name, genome) {
  ...
  print("organism 1 tag")
  print(organism_1_tag)
  print("organism 2 tag")
  print(organism_2_tag)

  # print(head(rowData(cds)))
  ...
  collision_rate <- round(sum(pData(cds)$collision/nrow(pData(cds))) * 200, 1)
  print(head(collision_rate))

  return(list(plot, collision_rate))
}
