...
print(head(corrected_hash_table))
...
print("corrected hash table dim")
dim(corrected_hash_table)
...
# setnames(merged, old = c("hash_umis.x","top_oligo.x","" new = "hash_umis")
# setnames(merged, old = "hash_umis.x", new = "hash_umis")
